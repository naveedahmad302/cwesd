...
const IdentityDocument: React.FC<IdentityDocumentProps> = ({
  imageUrl,
  isVerified = true,
}) => (
...
const ProfileScreen: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState<ProfileData>({
    ...
    cnicPicFront: user?.cnicPicFront || '',
    cnicPicBack: user?.cnicPicBack || '',
    role: user?.role || '',
    moodleCreatedAt: user?.moodleDetails?.moodleCreatedAt || null,
    moodleSyncStatus: user?.moodleDetails?.moodleSyncStatus || '',
    moodleSyncError: user?.moodleDetails?.moodleSyncError || null,
    moodleLastSyncAttempt: user?.moodleDetails?.moodleLastSyncAttempt || null,
      ...
      <View style={styles.containerTwo}>
          ...
          <View style={styles.headerButtonsContainer}>
            {isEditMode && (
              <TouchableOpacity
                ...
                style={[styles.headerEditButton, styles.cancelButton]}
              >
                <Icon name="close-outline" size={20} color="#666" />
                <StyledText
                  style={[styles.headerEditButtonText, styles.cancelButtonText]}
                >
                  Cancel
                </StyledText>
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              style={[styles.headerEditButton, isEditMode && styles.saveButton]}
            >
              <Icon
                name={isEditMode ? 'check-outline' : 'pencil-outline'}
                size={20}
              ...
              <StyledText
                style={[
                  ...
                  isEditMode && styles.saveButtonText,
                ]}
              >
            ...
            <Image
              source={{
                uri:
                  ...
                  'https://via.placeholder.com/120x120/4A90E2/FFFFFF?text=Profile',
              }}
        ...
        <ProfileSection title="Personal Information">
          ...
          <ProfileItem
            label="Father's Name"
            value={
              isEditMode ? tempProfileData.fatherName : profileData.fatherName
            }
            editable={isEditMode}
          ...
          <ProfileItem
            ...
            value={
              isEditMode
                ? tempProfileData.age.toString()
                : profileData.age.toString()
            }
            editable={isEditMode}
            onChangeText={text =>
              updateTempProfileData('age', parseInt(text) || 0)
            }
          />
          <ProfileItem
            label="Qualification"
        ...
        <ProfileSection title="Contact Information">
          ...
          <ProfileItem
            ...
            value={
              isEditMode
                ? tempProfileData.permanentAddress
                : profileData.permanentAddress
            }
            editable={isEditMode}
            onChangeText={text =>
              updateTempProfileData('permanentAddress', text)
            }
            multiline={true}
          />
        </ProfileSection>
        ...
        <ProfileSection title="Identity Documents">
          <View style={styles.documentsContainer}>
            <View style={styles.documentWithTitleContainer}>
              ...
              <IdentityDocument
                imageUrl={
                  profileData.cnicPicFront ||
                  'https://via.placeholder.com/300x200/f0f0f0/666666?text=CNIC+Front'
                }
                isVerified={true}
              />
            </View>
            <View style={styles.documentWithTitleContainer}>
              ...
              <IdentityDocument
                imageUrl={
                  profileData.cnicPicBack ||
                  'https://via.placeholder.com/300x200/f0f0f0/666666?text=CNIC+Back'
                }
                isVerified={true}
              />
            </View>

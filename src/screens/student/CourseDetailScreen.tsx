...
import { clearSelectedCourse } from '../../store/slices/appData';
import type { SelectedCourse } from '../../store/slices/appData';
import StyledText from '../../shared/components/StyledText';
import CourseSidebar from '../../shared/components/CourseSidebar';
import ContentDetailCard, {
  ContentDetailAction,
} from '../../shared/components/ContentDetailCard';
...
const CourseDetailScreen: React.FC = () => {
  ...
  const course = useAppSelector(state => state.appData.selectedCourse);
  ...
  // Clear selected course on unmount so we don't show stale data next time
  useEffect(() => {
    return () => {
          ...
          {selectedContent ? (
            <>
              <ContentDetailCard
                ...
                submissionStatus={
                  selectedContent.type === 'assignment' ? 'new' : 'new'
                }
                ...
                moodleId={
                  course?.moodleId?.toString() || course?.id?.toString() || '2'
                } // Use moodleId first, fallback to id
                sectionNumber="1" // Replace with actual section number
                instance={
                  selectedContent.instance?.toString() ||
                  selectedContent.id?.toString() ||
                  '2'
                } // Use instance first, fallback to id
            ...
            <View style={styles.announcementsCard}>
              ...
              >
                ...
                />
                <StyledText style={styles.openContentText}>
                  Open Content
                </StyledText>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.actionButtons}>
              ...
              >
                <ExternalLink
                  ...
                  style={styles.buttonIcon}
                />
                <StyledText style={styles.moodleButtonText}>
                  Open in Moodle
                </StyledText>
              </TouchableOpacity>
              ...
              >
                <CircleCheckBig
                  ...
                  style={styles.buttonIcon}
                />
                <StyledText style={styles.completeButtonText}>
                  Mark Complete
                </StyledText>
              </TouchableOpacity>
            </View>
